    ...
    <div class="main">
      <div class="main_inner dis-table">
        ...
        <div class="col-2 rel-position">
          ...
          <div class="tab">
            <div class="tab-item">
              <router-link :to="{path:'/'}"><i class="icon icon-message fs-28 txt-white"></i></router-link>
            </div>
            <div class="tab-item">
              <router-link :to="{path:'/contactor'}"><i class="icon icon-team fs-28" style="color: #3caf36"></i></router-link>
            </div>
